...
const Footer = () => {
    return (
        <footer className="mastfoot pb-5 bg-white section-padding pb-0" style={{ padding: '100px 0' }}>
            <div className="inner container">
                <div className="row">
                    <div className="col-lg-4">
                        <div className="footer-widget pr-lg-5 pr-0">
                            <img src={logo} style={{ width: '60px' }} className="img-fluid footer-logo mb-3" alt="" />
                    ...
                    <div className="col-lg-4">
                        <div className="footer-widget pl-lg-5 pl-0">
                            ...
                            <form id="newsletter">
                                ...
                                <button type="submit" className="btn-grad w-100">Submit</button>
                            </form>
                        </div>

                    </div>
                    <div className="col-md-12 d-flex align-items-center mt-4">
                        <p className="mx-auto text-center mb-0">Copyright &copy; 2021. All Right Reserved Design by <strong>Tajul Islam Refath</strong></p>
                    </div>
